...
public class MSSqlAuthService implements AuthService{
    ...
    private static MSSqlAuthService instance;

    private MSSqlAuthService(){ }

    public static MSSqlAuthService getInstance() {
        if(instance == null){		//если объект еще не создан
            instance = new MSSqlAuthService();	//создать новый объект
        }
        return instance;
    }
